...
|---|---|---|---|
| 1 | <hobi> yang ditulis dua kali berturut | Tidak dikelompokkan dalam satu elemen induk | <hobiList><hobi>...</hobi><hobi>...</hobi></hobiList> |
...
| 3 | Atribut nim, sedangkan nama, angkatan, dan programStudi ditulis sebagai elemen | Tidak konsisten dalam pemodelan data, harusnya data sejenis seperti identitaas mahasiswa direpresemtasikan dengan cara yang sama | Ubah nim menjadi elemen seperti ini, <nim>251402001</nim> <nama>Isi Nama Anda</nama <angkatan>2024</angkatan> <programStudi>Teknologi Informasi</programStudi> |
